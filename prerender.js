...
const ROUTES = [
  ...
  },
  {
    url: "/privacy",
    file: "privacy.html",
    title: "Privacy Policy — Savor & Potluck Recipe Apps", // 44 chars
    desc: "How the Savor and Potluck by Savor apps handle your data: what we collect, how it’s used, the third-party services involved, and how to delete your account.", // 156 chars
  ...
  },
  {
    ...
    file: "demo.html",
    title:
      "The Only Lasagne Recipe You'll Ever Need (An Odyssey) | The Hearth & Hollow",
...
for (const r of ROUTES) {
  ...
  const ogImage =
    r.ogImage || "https://getsavor.recipes/images/savor-final.png";

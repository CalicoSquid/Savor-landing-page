...
export default function CaperPrivacy() {
      ...
      <section style={{ padding: '70px 0 140px' }}>
        <div className="container" style={{ maxWidth: 680, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 20 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', opacity: 0.7, margin: 0 }}>
                Caper by CalicoSquid · Effective {EFFECTIVE}
              </p>
            </div>
          </div>
          ...
          <p style={{
            ...
            uses, and protects your information when you use the <strong style={{ color: 'var(--text-primary)' }}>Caper</strong> mobile
            app on Android and iOS. We built Caper to get people outside — not to harvest data.
          </p>

          {/* 1 */}
          {section('1. Who we are', <>
            {p('Caper is developed and operated by CalicoSquid, an independent developer. Questions about this policy: hello@getsavor.recipes with "Caper Privacy" in the subject line.')}
          </>)}
          ...
          {section('2. Information we collect', <>
            ...
            {li([
              ...
              'A Firebase Authentication UID — a unique identifier that links your Google account to your Caper account',
            ])}
            ...
            <h3 style={h3}>2.3 Campfire Kitchen (Caper Wild subscribers)</h3>
            {li([
            ...
            {p('When you run a Wild Food Near Me search, we store a list of scientific names of species found near you. This powers your Campfire Kitchen cookbook and badge system. Stored on your device and (if signed in) on our servers.')}

            <h3 style={h3}>2.5 Location data</h3>
            {p('Caper requests foreground location access ("precise location, while using the app") for two purposes only:')}
            {li([
            ...
            {li([
              ...
              'Browsing history or activity outside Caper',
          ...
          {section('3. How we use your information', <>
            {p('We use your information only to operate Caper:')}
            {table([
          ...
          {section('4. How we share your information', <>
            ...
            {[
              ...
              },
              {
                ...
                desc: 'Processes Caper Wild purchases entirely within Google Play. We never receive or store payment card details.',
          ...
          {section('7. Your rights', <>
            ...
            {li([
              ...
              'Withdrawal of consent — revoke location permission in device settings at any time. Wild Food Near Me will stop working; all other features remain available.',
            ])}
          ...
          {section('8. Location permission', <>
            {p('Caper requests foreground location (ACCESS_FINE_LOCATION on Android, "Precise Location" on iOS). This permission is used exclusively when you tap "Wild Food Near Me" and to name your logbook entries. We never request background location. You can revoke this permission at any time in your device settings without affecting any other feature.')}
          </>)}

          {/* 9 */}
          {section("9. Children's privacy", <>
            {p("Caper is not directed at children under 13 (or 16 in the EEA). We do not knowingly collect personal information from children. Contact hello@getsavor.recipes if you believe a child has created an account and we will delete it promptly.")}
          </>)}
          ...
          {section('11. Changes to this policy', <>
            {p('We may update this policy from time to time. When we do, we will update the effective date and, for material changes, notify you within the app. Continued use of Caper after changes take effect constitutes acceptance.')}
          </>)}
          ...
          <div style={{
            ...
            <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', lineHeight: 1.65, marginBottom: 10 }}>
              ...
              <a
                href="mailto:hello@getsavor.recipes?subject=Caper%20Privacy"

...
export default function DeleteForageAccount() {
  return (
      ...
      <section style={{ padding: '70px 0 140px' }}>
        <div className="container" style={{ maxWidth: 640, margin: '0 auto' }}>
          ...
          <p style={{
            ...
            You can delete your account and all associated personal data directly inside the Forage app. No emails, no forms — it's right there in Settings.
          </p>

          {/* Steps */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24, marginBottom: 48 }}>
            {[
              { n: '1', title: 'Open Forage', body: 'Launch the app on your Android or iOS device.' },
          ...
          <div style={{
            ...
            <p style={{ fontSize: '0.95rem', color: 'var(--text-secondary)', lineHeight: 1.7 }}>
              Your account, email address, logbook entries, saved species, and all personal data are permanently deleted immediately.
              Location data and foraging history stored on our servers are also removed.
            </p>
          </div>
          ...
          <div style={{
            ...
            <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', lineHeight: 1.65 }}>
              ...
              <a
                href="mailto:hello@getsavor.recipes?subject=Delete%20My%20Forage%20Account"

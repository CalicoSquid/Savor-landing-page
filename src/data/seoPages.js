...
export const STATIC_SEO_PAGES = [
  ...
  page({
    ...
    description: 'Free kitchen calculators by a chef: scale recipes, convert cups and grams, resize baking pans, plan portions, find substitutes, calculate brine and dough hydration.',
